...
public final class Constants {
    ...
    public static final String  SUBJECT_TODO_EXPIRATION = "Notification: Todo expiration date has expired";
    public static final String TODO_EXPIRATION_MESSAGE = "Hello, %s! \n" + "your todo named %s has expired.";
/*
    public static final String CRON = "0 0 8 * * *";
*/
    public static final String CRON = "*/10 * * * * *";
